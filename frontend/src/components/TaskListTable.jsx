      ...
      <table className="min-w-full">
        <thead>
          <tr className="text-left">
            <th className="py-3 px-4 text-gray-800 font-medium text-[17px]">Name</th>
            <th className="py-3 px-4 text-gray-800 font-medium text-[17px]">Status</th>
            <th className="py-3 px-4 text-gray-800 font-medium text-[17px] ">Priority</th>
            <th className="py-3 px-4 text-gray-800 font-medium text-[17px] hidden md:table-cell">Created On</th>
          </tr>
        </thead>
        <tbody>
          {tableData.map((task) => (
            <tr
              ...
              onClick={() => navigate(`/bugdetails/${task._id}`)}
            >
